...
#include "__system_context_default_query_system_context_interface.hpp"
...
extern
  ...
  return exec::__system_context_defaut_query_system_context_interface::
    __default_query_system_context_interface(__id);
}
